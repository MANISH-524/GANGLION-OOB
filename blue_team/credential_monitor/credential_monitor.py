#!/usr/bin/env python3
"""
Ganglion-OOB :: Blue Team Tool 12 — Credential Exposure & Auth-Abuse Monitor
=============================================================================
Original architecture. Three independent engines, each tuned for low FPs:
  ...
  1. PASSWORD-SPRAY DETECTOR
     ...
     Ganglion tracks, per source IP and per rolling window:
...
logger = logging.getLogger("ganglion.credmon")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Ganglion-OOB Credential Monitor")
    ...
    print(f"\n{B}  ── Ganglion-OOB Credential Monitor ──{R}\n")
