#!/usr/bin/env python3
"""
Ganglion-OOB :: Blue Team Tool 17 — Threat Hunter
==================================================
...
logger = logging.getLogger("ganglion.threat_hunter")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Ganglion-OOB Threat Hunter")
    ...
    print(f"\n{B}  ── Ganglion-OOB Threat Hunter ──{R}\n")
