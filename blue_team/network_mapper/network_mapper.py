#!/usr/bin/env python3
"""
Ganglion-OOB :: Blue Team Tool 8 — Network Mapper
==================================================
...
logger = logging.getLogger("ganglion.network_mapper")
...
<meta charset="UTF-8"><title>Ganglion-OOB Network Map</title>
<style>
...
<div id="header">
  <h1>⬡ GANGLION-OOB · NETWORK TOPOLOGY MAP</h1>
</div>
<div id="canvas">
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Ganglion-OOB Network Mapper")
    ...
    print(f"\n{B}  ── Ganglion-OOB Network Mapper ──{R}\n")
