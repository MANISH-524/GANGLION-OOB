#!/usr/bin/env python3
"""
Ganglion-OOB :: Blue Team Tool 2 — Log Analyzer & Anomaly Detector
===================================================================
...
logger = logging.getLogger("ganglion.log_analyzer")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Ganglion-OOB Log Analyzer")
    ...
    print(f"\n{ANSI}  ── Ganglion-OOB Log Analyzer ──{R}\n")
