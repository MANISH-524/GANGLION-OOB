#!/usr/bin/env python3
"""
Ganglion-OOB :: Blue Team Tool 20 — Memory Forensics Engine
============================================================
...
Modes:
  ...
  OFFLINE — parses a VirtualBox .core or Linux ELF core dump produced
             by the Ganglion control_center.py isolation sequence.
...
logger = logging.getLogger("ganglion.memforensics")
...
class MemoryFinding:
    ...
    def to_dict(self) -> dict:
        d = asdict(self)
        # Convert to Ganglion unified schema
        d.update({
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Ganglion-OOB Memory Forensics Engine")
    ...
    print(f"\n{B}  ── Ganglion-OOB Memory Forensics Engine ──{R}\n")
