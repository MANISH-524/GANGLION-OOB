#!/usr/bin/env python3
"""
Ganglion-OOB :: Blue Team Tool 4 — Packet Inspector
====================================================
...
logger = logging.getLogger("ganglion.packet_inspector")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Ganglion-OOB Packet Inspector")
    ...
    print(f"\n{B}  ── Ganglion-OOB Packet Inspector ──{R}\n")
