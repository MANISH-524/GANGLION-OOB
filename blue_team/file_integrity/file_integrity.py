#!/usr/bin/env python3
"""
Ganglion-OOB :: Blue Team Tool 9 — File Integrity Monitor (FIM)
================================================================
...
logger = logging.getLogger("ganglion.fim")
IS_LINUX = platform.system() == "Linux"

# ── Tamper-evidence key (per-deployment; rotate in production) ─────────────
BASELINE_HMAC_KEY = b"GanglionOOB-FIM-IntegrityKey-2025"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Ganglion-OOB File Integrity Monitor")
    ...
    print(f"\n{B}  ── Ganglion-OOB File Integrity Monitor ──{R}\n")
