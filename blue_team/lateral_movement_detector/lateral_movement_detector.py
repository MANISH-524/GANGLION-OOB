#!/usr/bin/env python3
"""
Ganglion-OOB :: Blue Team Tool 10 — Lateral Movement Detector
==============================================================
...
Core idea (novel vs. signature-only tools):
  ...
  Ganglion builds a directed AUTH GRAPH per rolling window and scores it for
...
logger = logging.getLogger("ganglion.lateral")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Ganglion-OOB Lateral Movement Detector")
    ...
    print(f"\n{B}  ── Ganglion-OOB Lateral Movement Detector ──{R}\n")
