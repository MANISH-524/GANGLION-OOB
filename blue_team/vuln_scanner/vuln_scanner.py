#!/usr/bin/env python3
"""
Ganglion-OOB :: Blue Team Tool 3 — Vulnerability Surface Scanner
=================================================================
...
logger = logging.getLogger("ganglion.vuln_scanner")
...
SERVICE_BANNERS: Dict[int, dict] = {
    ...
    25:    {"name": "SMTP",     "probe": b"EHLO ganglion\r\n", "pattern": re.compile(rb"^220|^250")},
...
def _print_report(report: ScanReport):
    ...
    print(f"\n{B}{'─'*62}{R}")
    print(f"  {B}GANGLION-OOB VULNERABILITY SCAN{R}")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Ganglion-OOB Vulnerability Scanner")
