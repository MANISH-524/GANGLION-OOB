#!/usr/bin/env python3
"""
Ganglion-OOB :: Blue Team Tool — Firewall Policy Engine
=======================================================
...
the decision logic, ordering, and enforcement wiring are Ganglion's own — so the
...
if __name__ == "__main__":
    ap = argparse.ArgumentParser(description="Ganglion-OOB firewall policy engine")
