#!/usr/bin/env python3
"""
Ganglion-OOB :: Blue Team Tool 14 — Behavioral Engine (UEBA)
=============================================================
...
positives by requiring statistical confidence before alerting.
  ...
  1. CIRCULAR TIME-OF-DAY MODEL
     ...
     Ganglion fits a von-Mises-like circular mean + spread per user from
...
logger = logging.getLogger("ganglion.ueba")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Ganglion-OOB Behavioral Engine (UEBA)")
    ...
    print(f"\n{B}  ── Ganglion-OOB Behavioral Engine (UEBA) ──{R}\n")
