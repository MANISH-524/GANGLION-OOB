#!/usr/bin/env python3
"""
Ganglion-OOB :: Blue Team Tool 5 — IOC Hunter
==============================================
...
logger = logging.getLogger("ganglion.ioc_hunter")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Ganglion-OOB IOC Hunter")
