#!/usr/bin/env python3
"""
Ganglion-OOB :: Blue Team Tool 11 — DNS Threat Analyzer
========================================================
...
logger = logging.getLogger("ganglion.dns_analyzer")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Ganglion-OOB DNS Threat Analyzer")
    ...
    print(f"\n{B}  ── Ganglion-OOB DNS Threat Analyzer ──{R}\n")
