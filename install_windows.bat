@echo off
REM ============================================================
REM  Ganglion-OOB :: Windows Quick-Install Script
...
echo.
echo  ==========================================
echo   GANGLION-OOB :: Dependency Installer
echo  ==========================================
echo.
...
echo.
echo  Next steps:
echo    EASIEST: double-click  run.bat  (starts everything + opens the dashboard)
...
echo.
echo    NOTE: For real deployments set GANGLION_MASTER_KEY (same value on the
...
echo         cd blue_team
echo         python ganglion.py tools
echo    Run a full audit:
echo         python ganglion.py audit --path C:\Windows\System32
echo    Launch Master SOC Dashboard:
echo         python ganglion.py dashboard --port 8080
