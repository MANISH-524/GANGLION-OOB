#!/usr/bin/env python3
"""
Vanguard-OOB :: Reflex Arc (spinal-level fast path)
===================================================
...
be too slow. Vanguard mirrors this: a small set of unambiguous, high-confidence
signals trigger an immediate protective action locally, without waiting for the
full correlation/scoring pass in the CNS.

This is what gives Vanguard its millisecond containment on the signals that
