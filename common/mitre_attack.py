#!/usr/bin/env python3
"""
Ganglion-OOB :: MITRE ATT&CK Intelligence Layer
================================================
...
module maps Ganglion's raw telemetry events to ATT&CK technique IDs, tactics,
...
TECHNIQUES: Dict[str, Technique] = {
    ...
    "T1190": Technique("T1190", "Exploit Public-Facing Application", ["TA0001"],
                       "Web-layer exploitation (SQLi/XSS/RCE/SSRF/JNDI) against exposed apps."),
    "T1046": Technique("T1046", "Network Service Discovery", ["TA0007"],
                       "Port/service scanning to map the attack surface."),
    "T1595": Technique("T1595", "Active Scanning", ["TA0043"],
                       "Probing/enumeration of targets prior to exploitation."),
}
...
# ---------------------------------------------------------------------------
# Map Ganglion event_type (+ optional reason discriminator) to technique IDs.
