#!/usr/bin/env bash
# ============================================================
#  Ganglion-OOB :: Linux / macOS Quick-Install Script
...
echo -e "${CYAN}    cd blue_team && ${PYTHON_CMD} ganglion.py tools${RESET}"
echo ""
echo    "  Run a full hardening + IOC + integrity audit:"
echo -e "${CYAN}    ${PYTHON_CMD} ganglion.py audit --path /etc${RESET}"
echo ""
echo    "  Launch the Master SOC Dashboard (all 21 tools):"
echo -e "${CYAN}    ${PYTHON_CMD} ganglion.py dashboard --port 8080${RESET}"
