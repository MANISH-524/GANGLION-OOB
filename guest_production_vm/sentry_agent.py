#!/usr/bin/env python3
"""
Ganglion-OOB :: Sentry Agent  (v2 — secured + crypto-spike aware)
=================================================================
...
# ---------------------------------------------------------------------------
_AGENT_LOG_PATH = os.environ.get("GANGLION_AGENT_LOG",
...
class SentryAgent:
    ...
    def run(self):
        ...
        print(f"[*] Ganglion Sentry Agent v2 starting. VM: {self.tunnel.vm_id}")
...
def main():
    parser = argparse.ArgumentParser(description="Ganglion-OOB Sentry Agent v2")
