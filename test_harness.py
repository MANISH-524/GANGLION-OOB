#!/usr/bin/env python3
"""
Ganglion-OOB :: Integration Test Harness
==========================================
...
def banner():
  ...
  ╚██████╔╝██║  ██║██║ ╚████║╚██████╔╝███████╗██║╚██████╔╝██║ ╚████║
   ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═══╝ ╚═════╝ ╚══════╝╚═╝ ╚═════╝ ╚═╝  ╚═══╝
"""))
    print(c("dim", "  Ganglion-OOB Integration Test Harness — Adversary Simulation Engine\n"))
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Ganglion-OOB Integration Test Harness"
    )
